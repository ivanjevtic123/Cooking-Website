$(document).ready(function() {
    ...
    if(recept.grupa == 'desert') $("#putanja").append("dessert/").append(recept.ime);
    if(recept.grupa == 'uzina') $("#putanja").append("snack/").append(recept.ime);
    if(recept.grupa == 'glavnoJelo') $("#putanja").append("main course/").append(recept.ime);
    if(recept.grupa == 'predjelo') $("#putanja").append("appetizer/").append(recept.ime);
    ...
    if(recept != null) {
        ...
        append(
            ...
            +"</video>"
        ).append("<hr>").append("<h2>Comments</h2>").append("<br>");
        ...
        $("#recept_solo").append("<br>").append("<hr>").append("<br>").append("<h2>Downloading</h2>").append("<br>").append(
            "<button id='preuzmiPdf' class='btn btn-secondary'>Download PDF</button>"
        ).append("<br>");
            ...
            if(mealsArr_LS_3[i].id == id) {//zbir, suma++
                ...
                for(let j = 0; j < mealsArr_LS_3[i].ocene_usernames.length; j++) {
                    if(mealsArr_LS_3[i].ocene_usernames[j] == username_curr) {
                        ...
                        alert("You have already rated this recepie!");
                        break;
                    }
                }
